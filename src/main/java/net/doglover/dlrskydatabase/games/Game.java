package net.doglover.dlrskydatabase.games;

public enum Game {
    SPYROS_ADVENTURE(1, "Skylanders: Spyro's Adventure", "Bring the Skylanders to Life!",
    ...
    GIANTS(2, "Skylanders: Giants", "Go Big!",
    ...
    SWAP_FORCE(3, "Skylanders: Swap Force", "Swappable. Unstoppable.",
    ...
    TRAP_TEAM(4, "Skylanders: Trap Team", "Capture Evil. Unleash Good.",
            "Star 1 Objectives", "Star 2 Objectives", "Collections",
    ...
    SUPERCHARGERS(5, "Skylanders: SuperChargers", "Drive Evil Crazy!",
    ...
    IMAGINATORS(6, "Skylanders: Imaginators", "Unleash Imagination, Create Your Own Skylanders!",
    ...
    /* --- Constructor --- */
    Game(int number, String name, String tagline, String objectives1Name, String objectives2Name, String objectives3Name,  String description) {
        this.number = number;
        this.name = name;
