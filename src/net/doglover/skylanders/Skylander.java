...
import net.doglover.skylanders.abilities.SkylanderAbilityTree;
import net.doglover.skylanders.alignment.BattleClass;
import net.doglover.skylanders.alignment.Element;
import net.doglover.skylanders.alignment.SwapAbility;
...
public class Skylander {
    ...
    public static final Skylander KAOS = new Builder("Kaos", Game.IMAGINATORS, Element.KAOS)
            .catchphrase("Behold, My Catchphrase of Doom!").soulGemChapter(Chapter.THE_LAIR_OF_KAOS).build();
