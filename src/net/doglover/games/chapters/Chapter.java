package net.doglover.games.chapters;

import net.doglover.games.Game;
import net.doglover.games.chapters.objectives.CollectionObjective;
import net.doglover.games.chapters.objectives.Objective;
import net.doglover.games.chapters.objectives.TimeObjective;
import net.doglover.games.chapters.objectives.TitleObjective;
import net.doglover.skylanders.alignment.BattleClass;
